...
在自然语言中，“或”往往带有**排他性**。比如：
- 在日常生活中，比如问：“你晚饭想喝茶或咖啡？”（通常暗示你只能选一种）
- 在几何中，“两条直线平行或相交”（它们不可能同时既平行又相交）。

但在逻辑学中，除非特别说明，算符 $\lor$ 默认是 **包含性** 的。这意味着 $P$ 和 $Q$ 可以同时成立。
...
析取最核心的威力在于**分类讨论**。当我们知道几种可能性必居其一时，如果我们能证明每种可能性都能推导出同一个结论，那么这个结论就是确定的。
