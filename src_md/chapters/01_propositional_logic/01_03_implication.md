...
现在，我们在处理一道具体的题目，已知该题目符合前提，两个角是对顶角：$\Gamma \vdash P$ 。利用推理线，我们将定理“消费”掉，从而挖掘出新事实，这两个角相等：$\Gamma \vdash Q$
...
在阅读逻辑教材或学术论文时，我们可能会发现很多推理线上并没有写出 $\Gamma \vdash$ 这一串符号，而是直接写成：

$$ \frac{P \quad P \to Q}{Q} \text{ ($\to$-消去)} $$
